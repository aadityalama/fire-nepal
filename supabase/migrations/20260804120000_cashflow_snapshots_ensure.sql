-- Ensure Cashflow snapshots table exists with grants + PostgREST schema reload.
-- Idempotent. Preferred storage for /api/cashflow; app falls back to fire_goals when missing.
