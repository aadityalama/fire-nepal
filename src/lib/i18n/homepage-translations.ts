...
const english: HomepageCopy = {
  ...
  home: {
    ...
    fireTools: [
      ...
      { title: "Expense Tracker", body: "Track personal daily expenses", href: "/finance/expense" },
  ...
  kr: {
    ...
    home: {
      ...
      fireTools: [
        ...
        { title: "지출 트래커", body: "개인 일상 지출 추적", href: "/finance/expense" },
  ...
  np: {
    ...
    home: {
      ...
      fireTools: [
        ...
        { title: "खर्च ट्र्याकर", body: "व्यक्तिगत दैनिक खर्च ट्र्याक गर्नुहोस्", href: "/finance/expense" },
