...
const english: HomepageCopy = {
  ...
  hero: {
    ...
    liveUi: "Live UI",
    progressLabels: ["FIRE corpus", "Emergency fund", "Remittance plan"],
    savedAbroad: "Saved abroad",
  ...
  home: {
    ...
    tools: [
      ...
      { title: "Family Wealth + Child Education", body: "Plan your family's future, child education, savings and long-term wealth goals.", href: "/family" },
      { title: "Remittance planning", body: "Convert salary to NPR for remit vs invest", href: "/currency-converter" },
      { title: "SIP Calculator Nepal", body: "Estimate mutual fund SIP returns in NPR", href: "/sip-calculator" },
      ...
      { title: "Loan / EMI Planner", body: "EMI for Nepal return", href: "/smart-loan-os" },
    ...
    fireTools: [
      ...
      { title: "Expense Tracker", body: "Track personal daily expenses", href: "/expense-dashboard?finance=personal" },
      { title: "Saving Goals", body: "Monthly KRW/NPR savings growth", href: "#dashboard" },
      { title: "Reminder Planner", body: "Bills, school fees, family-shared nudges", href: "/smart-reminders" },
      { title: "SIP Calculator Nepal", body: "SIP investment calculator with step-up & NPR charts", href: "/sip-calculator" },
      ...
      { title: "SIP Calculator Nepal", body: "Plan monthly SIP in NPR with step-up", href: "/sip-calculator" },
    ],
    loanCards: [
    ...
    videos: [
      { title: "Overseas income to FIRE strategy", duration: "9:05", gradient: "from-green-950 to-emerald-700" },
    ...
    posts: [
      { title: "How to invest your abroad salary for Nepal goals", tag: "Money guide", time: "5 min read" },
      { title: "FIRE mistakes Nepali workers make abroad", tag: "Retirement", time: "7 min read" },
      { title: "Multi-currency remittance: what to track before coming home", tag: "Currency", time: "4 min read" },
    ],
    testimonials: [
    ...
    loanBody: "Manage family lending, shared expenses abroad, EMI pressure, document proof, QR receipts, and FIRE impact from one premium credit dashboard.",
    ...
    aiAdvisorTitle: "Your personal FIRE guide for building wealth abroad and planning your return to Nepal.",
    aiAdvisorBody: "Ask about savings, remittance, investing, retirement, insurance, taxes, or your Nepal return plan.",
    advisorTopics: [
      "How many years until I can return to Nepal?",
      "How much should I save every month?",
      "Plan my FIRE journey",
      "Should I send money to Nepal now?",
      "How much emergency fund do I need?",
      "How much insurance do I need?",
    ],
    fireBot: "FIRE Bot",
    fireBotStatus: "Ready · portfolio-aware when signed in",
    fireBotMessage: "Where should we start? Ask about your FIRE number, Nepal return plan, savings, remittance, insurance, or investment risk.",
    ...
    footerBody: "FIRE tips, currency alerts, and investment strategy for Nepalis abroad.",
    ...
    builtFor: "Built for Nepalis living, working and studying abroad.",
  },
  trust: {
    ...
    bullets: [
      ...
      "Built for the global Nepali diaspora — NPR, KRW, USD, EUR, GBP, AUD, and more.",
    ],
...
export const homepageTranslations: Record<LanguageCode, HomepageCopy> = {
  ...
  kr: {
    ...
    hero: {
      ...
      badge: "전 세계 네팔인을 위한 프리미엄 금융 플랫폼 — 해외에서 살고, 일하고, 공부하는 이들을 위해.",
      ...
      liveUi: "실시간 UI",
      progressLabels: ["FIRE 자산", "비상금", "송금 계획"],
      savedAbroad: "해외 저축",
      nepalCorpus: "네팔 자산",
      watchDemo: "데모 보기",
    },
    home: {
      ...
      tools: [
        ...
        { title: "가족 자산 + 자녀 교육", body: "가족의 미래, 자녀 교육, 저축 및 장기 자산 목표를 계획하세요.", href: "/family" },
        { title: "송금 계산기", body: "수수료와 처리 시간을 비교", href: "/currency-converter" },
        { title: "네팔 SIP 계산기", body: "NPR 기준 월 적립 수익 추정", href: "/sip-calculator" },
        ...
        { title: "대출 계산기", body: "네팔 귀국을 위한 EMI", href: "/smart-loan-os" },
      ...
      fireTools: [
        ...
        { title: "지출 트래커", body: "개인 일상 지출 추적", href: "/expense-dashboard?finance=personal" },
        { title: "저축 트래커", body: "월별 KRW/NPR 저축 성장", href: "#dashboard" },
        { title: "리마인더 플래너", body: "청구서, 학비, 가족 공유 알림", href: "/smart-reminders" },
        { title: "네팔 SIP 계산기", body: "스텝업 포함 SIP 투자 계산기", href: "/sip-calculator" },
        ...
        { title: "네팔 SIP 계산기", body: "월별 SIP와 스텝업 계획", href: "/sip-calculator" },
      ],
      loanCards: [
      ...
      osTitle: "전 세계 네팔인을 위한 프리미엄 금융 운영 시스템.",
      ...
      aiAdvisorTitle: "해외에서 자산을 만들고 네팔 귀국을 준비하는 나만의 FIRE 가이드.",
      aiAdvisorBody: "저축, 송금, 투자, 은퇴, 보험, 세금, 네팔 귀국 계획에 대해 질문하세요.",
      advisorTopics: ["네팔 귀국까지 몇 년?", "매월 얼마 저축?", "FIRE 여정 계획", "지금 송금할까?", "비상금은 얼마?", "보험은 얼마?"],
      fireBotStatus: "준비됨 · 로그인 시 포트폴리오 인식",
      fireBotMessage: "어디서 시작할까요? FIRE 숫자, 귀국 계획, 저축, 송금, 보험, 투자 위험에 대해 물어보세요.",
      ...
      subscribe: "구독하기",
      footerBrandBody: "다중 통화 계획, 저축 추적, 투자 교육, 귀국 준비를 하나의 프리미엄 대시보드에서.",
      footerColumns: [
      ...
      builtFor: "해외에서 살고, 일하고, 공부하는 네팔인을 위해 제작.",
    },
    trust: {
      ...english.trust,
      encryption: "은행급 암호화",
  ...
  ja: {
    ...
    hero: {
      ...
      badge: "世界中のネパール人のためのプレミアム金融プラットフォーム — 海外で暮らし、働き、学ぶ人のために。",
      ...
      liveUi: "ライブUI",
      progressLabels: ["FIRE資産", "緊急資金", "送金計画"],
      savedAbroad: "海外での貯蓄",
      nepalCorpus: "ネパール資産",
      watchDemo: "デモを見る",
    },
    home: {
      ...
      osTitle: "世界中のネパール人のためのプレミアム金融オペレーティングシステム。",
      ...
      aiAdvisorBody: "退職後の不労所得、節税ヒント、送金タイミング、緊急計画、国境を越えた資産形成とネパールでの生活設計に関する個別アドバイス。",
      ...
      footerBody: "海外のネパール人向けのFIREヒント、通貨アラート、投資戦略。",
      emailPlaceholder: "メールアドレスを入力",
      subscribe: "今すぐ登録",
      footerBrandBody: "多通貨計画、貯蓄追跡、投資教育、帰国準備を1つのプレミアムダッシュボードで。",
      footerColumns: [
      ...
      builtFor: "海外で暮らし、働き、学ぶネパール人のために構築。",
    },
    trust: {
      ...english.trust,
  ...
  np: {
    ...
    hero: {
      ...
      badge: "विश्वभरका नेपालीका लागि प्रिमियम वित्तीय प्लेटफर्म — विदेशमा बस्ने, काम गर्ने र पढ्नेहरूका लागि।",
      ...
      liveUi: "लाइभ दृश्य",
      progressLabels: ["FIRE कोष", "आपतकालीन कोष", "रेमिटेन्स योजना"],
      savedAbroad: "विदेशमा बचत",
    ...
    home: {
      ...
      tools: [
        ...
        { title: "पारिवारिक सम्पत्ति + बाल शिक्षा", body: "परिवारको भविष्य, बाल शिक्षा, बचत र दीर्घकालीन सम्पत्ति लक्ष्यहरू योजना बनाउनुहोस्।", href: "/family" },
        { title: "रेमिटेन्स क्याल्कुलेटर", body: "शुल्क र समय तुलना गर्नुहोस्", href: "/currency-converter" },
        { title: "SIP Calculator Nepal", body: "NPR मा मासिक SIP प्रतिफल अनुमान", href: "/sip-calculator" },
        ...
        { title: "ऋण क्याल्कुलेटर", body: "नेपाल फर्कने योजनाका लागि EMI", href: "/smart-loan-os" },
      ...
      fireTools: [
        ...
        { title: "खर्च ट्र्याकर", body: "व्यक्तिगत दैनिक खर्च ट्र्याक गर्नुहोस्", href: "/expense-dashboard?finance=personal" },
        ...
        { title: "SIP Calculator Nepal", body: "स्टेप-अप सहित SIP लगानी क्याल्कुलेटर", href: "/sip-calculator" },
        ...
        { title: "SIP Calculator Nepal", body: "मासिक SIP योजना NPR मा", href: "/sip-calculator" },
      ],
      loanCards: [
      ...
      osTitle: "विश्वभरका नेपालीका लागि तपाईंको प्रिमियम वित्तीय अपरेटिङ सिस्टम।",
      ...
      aiAdvisorTitle: "विदेशमा सम्पत्ति बनाउँदै नेपाल फर्कने योजनाका लागि तपाईंको व्यक्तिगत FIRE गाइड।",
      aiAdvisorBody: "बचत, रेमिटेन्स, लगानी, निवृत्ति, बीमा, कर, वा नेपाल फर्कने योजनाबारे सोध्नुहोस्।",
      advisorTopics: [
        "नेपाल फर्कन कति वर्ष लाग्छ?",
        "मासिक कति बचत गर्ने?",
        "मेरो FIRE यात्रा योजना",
        "अहिले रेमिटेन्स पठाउने?",
        "आपतकालीन कोष कति?",
        "बीमा कति चाहिन्छ?",
      ],
      fireBot: "FIRE बोट",
      fireBotStatus: "तयार · साइन इन गर्दा पोर्टफोलियो-सचेत",
      fireBotMessage: "कहाँबाट सुरु गर्ने? FIRE अंक, नेपाल फिर्ती, बचत, रेमिटेन्स, बीमा वा लगानी जोखिमबारे सोध्नुहोस्।",
      ...
      footerBody: "विदेशमा रहेका नेपालीका लागि FIRE टिप्स, मुद्रा अलर्ट, र लगानी रणनीति।",
      emailPlaceholder: "तपाईंको इमेल लेख्नुहोस्",
      subscribe: "अहिले सदस्य बन्नुहोस्",
      footerBrandBody: "बहु-मुद्रा योजना, बचत ट्र्याकिङ, लगानी शिक्षा, र नेपाल फर्कने तयारी एउटै प्रिमियम ड्यासबोर्डमा।",
      footerColumns: [
      ...
      builtFor: "विदेशमा बस्ने, काम गर्ने र पढ्ने नेपालीका लागि बनाइएको।",
    },
    trust: {
      ...english.trust,
      ...
      bullets: [
        ...
        "विश्वव्यापी नेपाली डायस्पोराका लागि बनाइएको — NPR, KRW, USD, EUR, GBP, AUD र थप।",
      ],
