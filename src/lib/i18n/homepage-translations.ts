...
const english: HomepageCopy = {
  ...
  home: {
    ...
    aiAdvisorBody: "Personalized advice for retirement passive income, tax-saving tips, remittance timing, emergency planning, and wealth building across borders and back home in Nepal.",
    ...
    fireBotMessage: "Based on your abroad income, increase monthly savings, keep 6 months in NPR cash, and split new investments 60% mutual funds, 25% FD, 15% equities.",
...
export const homepageTranslations: Record<LanguageCode, HomepageCopy> = {
  ...
  np: {
    ...
    home: {
      ...
      aiAdvisorBody: "निवृत्ति निष्क्रिय आम्दानी, कर बचत टिप्स, रेमिटेन्स समय, आपतकालीन योजना र सीमापार सम्पत्ति निर्माण तथा नेपालमा फर्कने योजनाका लागि व्यक्तिगत सल्लाह।",
