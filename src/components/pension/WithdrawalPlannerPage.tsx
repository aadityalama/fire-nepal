  ...
  return (
    ...
    >
      ...
      <PensionGlassPanel className="p-4 sm:p-5">
        ...
        <PensionHeading>Withdrawal & loan rules</PensionHeading>
        <PensionBody className="mt-1.5">
          Review verified institution notes below, then complete any withdrawal request on the official portal.
        </PensionBody>
