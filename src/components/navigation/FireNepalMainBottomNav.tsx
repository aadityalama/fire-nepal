...
const MAIN_NAV = [
  ...
  { href: "/finance", labelKey: "finance" as const, icon: Banknote, match: (p: string) => p.startsWith("/finance") || p.startsWith("/cashflow") || p.startsWith("/expense-dashboard") || p.startsWith("/savings-tracker") || p.startsWith("/budget") || p.startsWith("/insurance") || p.startsWith("/finance-analytics") },
