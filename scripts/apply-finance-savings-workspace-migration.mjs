#!/usr/bin/env node
/**
 * Apply finance_savings_workspace ensure migration to production.
 *
 * Requires ONE of:
 ...
 *   scripts/finance-savings-workspace-production-migration-combined.sql
 *
...
const migrationFile = "20260801143000_finance_savings_workspace_ensure.sql";
...
console.log("\n--- finance_savings_workspace production migration apply ---\n");
...
Until the table exists, /api/savings uses public.fire_goals as a compatible cloud fallback.
`);
process.exit(1);
