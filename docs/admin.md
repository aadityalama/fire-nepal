...
- **`/admin/members`** — Membership directory: expiry, days remaining, status badges, search/filters, renew / suspend / reactivate (API: `GET/PATCH /api/admin/members`).
